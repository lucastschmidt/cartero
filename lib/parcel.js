  ...
  _.each( parcelRegistry, function( parcel ) {
    if(_.isArray(parcel.includedParcels)){
      parcel.includedParcels = _.map(parcel.includedParcels, function(includedParcel){
        ...
        includedParcel.keepSeparate = false;
...
function createRegistryForDirectory( directory, rootDir, dirOptions ) {
  ...
  _.each( pageFiles, function( fileName ) {
    ...
    if( !_.isNull( carteroExtendsMatches ) ) {
      ...
      extendsParcel = dirOptions.findExtendedParcel(directory, pageFileContents, fileName);
    ...
    if(_.isFunction(dirOptions.findIncludedParcels)){
      includedParcels = dirOptions.findIncludedParcels(directory, pageFileContents, fileName);
